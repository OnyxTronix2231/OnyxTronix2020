...
import static robot.climber.ClimberConstants.ClimberComponentsA.LEFT_DOUBLE_SOLENOID_PORT;
import static robot.climber.ClimberConstants.ClimberComponentsA.RIGHT_DOUBLE_SOLENOID_PORT;
...
public class BasicClimberComponentsA implements ClimberComponents {
  ...
  public BasicClimberComponentsA() {
    ...
    doubleSolenoid = new DoubleSolenoid(LEFT_DOUBLE_SOLENOID_PORT,
        RIGHT_DOUBLE_SOLENOID_PORT);
  }
