...
public class TransportToShooterConstants {
    ...
    public static final double TRANSPORT_TO_SHOOTER_SPEED = 1; //TODO check and change
    public static final int CONTINUOUS_CURRENT_LIMIT = 0; //TODO check and change
    public static final int PICK_AMP_DURATION = 0; //TODO check and change
    public static final int PICK_AMP = 0; //TODO check and change
}
