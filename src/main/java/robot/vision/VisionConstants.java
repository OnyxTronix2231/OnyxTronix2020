...
public final class VisionConstants {
  ...
  public static Vector2dEx VECTOR_OUTER_INNER_TARGET = new Vector2dEx(DISTANCE_BETWEEN_OUTER_INNER_TARGET, 0);
  ...
  public static final class RobotAConstants {
    ...
    public static Vector2dEx VECTOR_LIMELIGHT_TURRET_CENTER = new Vector2dEx(LIMELIGHT_TURRET_CENTER_CM, 0);
    public static final double ROBOT_TURRET_DISTANCE = 0; // TODO: Check and change
  }
}
