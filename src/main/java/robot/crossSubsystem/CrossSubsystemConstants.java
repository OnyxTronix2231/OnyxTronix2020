...
public class CrossSubsystemConstants {
  ...
  static final double TIME_BETWEEN_BALLS = 100; //TODO check and  change if need
  static final double DELAY_AFTER_SHOOT = 0; //TODO check and  change if need
  static final double LOADER_DELAY = 0.3; //TODO check and  change if need
