...
public final class ClimberConstants {
  ...
  public static final class ClimberComponentsA {
    ...
    static final int LEFT_DOUBLE_SOLENOID_FORWARD_PORT = 0; // TODO: check value
    static final int LEFT_DOUBLE_SOLENOID_REVERSE_PORT = 1; // TODO: check value
    static final int RIGHT_DOUBLE_SOLENOID_FORWARD_PORT = 0; // TODO: check value
    static final int RIGHT_DOUBLE_SOLENOID_REVERSE_PORT = 1; // TODO: check value
